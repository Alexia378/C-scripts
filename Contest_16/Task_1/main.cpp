...
void fillInConstraints(int n, const char *up, const char *down, const char *left, const char *right, char **&result) {
...
void fillInRows(int n, char **&result) {
...
//        std::cout << up[i] << ':';
//    }
    fillInConstraints(n, up, down, left, right, result);
